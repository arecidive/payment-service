...
Доступ к технической административной панели предоставляется по адресу: http://localhost/admin/. 

Доступ к Swagger UI осуществляется по адресу: http://localhost/api/docs/.
